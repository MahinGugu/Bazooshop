...
class ProductCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ImageField::new('image')->setLabel('Image')->setHelp('Image du produit en 600x600 pixels')->setUploadedFileNamePattern('[year]-[month]-[day]-[contenthash].[extension]')->setBasePath('/uploads')->setUploadDir('public\uploads'),
            NumberField::new('price')->setLabel('Prix HT')->setHelp('Prix HT de votre produit, sans le sigle €'),
